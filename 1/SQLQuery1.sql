...
(
	...
	FILENAME = 'D:\DataBase\MyDB\MyDB.mdf',		-- Указываем Физическое полное имя файла БД.
...
( 
	...
	FILENAME = 'D:\DataBase\MyDB\MyDB.ldf',        -- Указываем Физическое полное имя файла журнала БД.
